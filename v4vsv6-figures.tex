...
\newcommand{\SmallCountriesCorporate}{
    \begin{table}[t]
        ...
        \scalebox{0.6}{
            ...
            \label{tab:v4vsv6-small-countries-corporate}
    \end{table}
}
...
\newcommand{\SomeCountryTable}{
    \begin{table}[ht]
        ...
        \label{tab:v4vsv6-country-resolvers}
    \end{table}
}
...
\textbf{Global}            & \textbf{ 7441} & \textbf{3.6\%} & \textbf{3.0\%} & \textbf{2.6\%} & \textbf{2.7\%} \\ % avg 3.0 stdev 7.0 med 0.4
        ...
        \caption{\textbf{Base rate medians; rest of countries not included in Table~\ref{tab:v4vsv6-base-rate}}}
    \end{table}
}
...
\textbf{Global}            & \textbf{ 7441} & \textbf{3.6\%} & \textbf{3.0\%} & \textbf{2.6\%} & \textbf{2.7\%} \\ % avg 3.0 stdev 7.0 med 0.4
        ...
        \caption{\textbf{Base rate; rest of countries not included in Table~\ref{tab:v4vsv6-base-rate}}}
    \end{table}
}
...
\newcommand{\FigDNSCensorship}{
    \begin{figure}[h!]
        ...
        \label{fig:v4vsv6-dns_censorship}
      \end{figure}
