\section{Introduction}\label{sec:v4vsv6-intro}
...
The remainder of this paper is organized as follows. \Cref{sec:v4vsv6-background} provides
...
considerations in \Cref{sec:v4vsv6-methodology} before presenting our findings on the
global prevalence of IPv6 censorship in \Cref{sec:v4vsv6-prevalence}. We then dig into
per country analysis based on Resource Record types in \Cref{sec:v4vsv6-resources} and
IP protocol version in \Cref{sec:v4vsv6-infrastructure}. We select several case studies
to highlight in \Cref{sec:v4vsv6-cases} before covering related work in
\Cref{sec:v4vsv6-related}. Finally \Cref{sec:v4vsv6-discussion} provides discussion and
...
%     and filtering unreliable DNS resolvers.
  ...
  \item {\it Measure prevalence of DNS censorship (\Cref{sec:v4vsv6-prevalence}).} 
...
researchers, in \Cref{sec:v4vsv6-discussion}.
