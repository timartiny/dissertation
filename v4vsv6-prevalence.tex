...
%
In each case, we use our collected dataset (\cf \Cref{sec:v4vsv6-methodology}) to
summarize the base rate of censorship.

\input{v4vsv6-tab-prevalence-rates-shaded.tex}
...
\Cref{tab:v4vsv6-prevalence:rates}. A full description along with breakdowns by
network connection types is provided in the Appendix (\Cref{tab:v4vsv6-appendix:rates}
and \Cref{tab:v4vsv6-prevalence:rates:broken}).
%
...
networks (\Cref{tab:v4vsv6-prevalence:rates:broken}), we see that the presence of
...
combinations in \Cref{tab:v4vsv6-prevalence:rates}. 
%
...
interesting patterns as specific case studies in \Cref{sec:v4vsv6-cases}.
