...
%
\chapter{Improving Signal's Sealed Sender}
...
\input{signal-introduction}
\input{signal-background}

\input{signal-attack}
\input{signal-attack-eval}

\input{signal-securitydefinitions}
\input{signal-appendixdefinitions}

\input{signal-solution}

\input{signal-discussion}

\input{signal-related-work}

\input{signal-conclusion}
