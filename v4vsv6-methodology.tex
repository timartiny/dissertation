\section{Dataset and Methodology}\label{sec:v4vsv6-methodology}
...
our queries (\Cref{sec:v4vsv6-methodology:resolvers}), domains that are the subject of
our queries (\Cref{sec:v4vsv6-methodology:domains}), and our process for identifying
the occurrence of a censorship event from the results of each query
(\Cref{sec:v4vsv6-methodology:censorship}).
...
\Cref{tab:v4vsv6-appendix:rates} illustrates the geographic distribution of the
resolvers.
...
results (\cf \Cref{sec:v4vsv6-methodology:domains}).
